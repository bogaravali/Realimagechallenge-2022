class SolutionTwoController < ActionController::Base


    def solution_two_csv

    #assigned deliveries to all possible partners accoding to the capacity
   
        d_patners = get_delivery_patners
        ...
        write_output("public/output2.csv", output_array)
        output_array
      ...
      def get_capacities
        ...
        capacities_csv = File.read('public/capacities.csv')
